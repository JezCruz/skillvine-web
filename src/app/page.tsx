      ...
      <main>
        <div id="about-tab" className="tab-popup">
          <div className="tab-content">
            ...
            <p>
              ...
              learn new skills online. Our platform is secure, reliable, and
              fun. We value learning, growth, and building trusted
        ...
        <section className="hero">
          <div className="hero-content">
            ...
            <h1 id="h1-font-style">
              Learn New Skills with Our Trusted Teachers, Let&apos;s Grow with
              Skillvine
            </h1>
            <p id="p-font-style">
        ...
        <section className="features" id="features">
          <div className="signup">
            <Link className="text-signup" href="/signup">
              Sign Up Now
            </Link>
          </div>
